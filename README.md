...
- **Alarm Aggregate**
  - Entity: Alarm
  - 이벤트: AlarmCreated, AlarmEdited, StaffAlarmed, CustomerAlarmed, SalesmanAlarmed
...
- **CreateAlarm**: 생성 이벤트 발생 시, 데이터 저장
- **EditAlarm**: 수정 이벤트 발생 시, 데이터 저장
